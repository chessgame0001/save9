...
public class BishopChessComponent extends ChessComponent {
    ...
    public void loadResource() throws IOException{
        if (BISHOP_WHITE == null) {
            BISHOP_WHITE = ImageIO.read(new File("C:\\Users\\Gypsophila\\IdeaProjects\\ChessDemo\\src\\images\\bishop-white.png"));
        }

        if (BISHOP_BLACK == null) {
            BISHOP_BLACK = ImageIO.read(new File("C:\\Users\\Gypsophila\\IdeaProjects\\ChessDemo\\src\\images\\bishop-black.png"));
        }
    }
