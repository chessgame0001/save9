...
public class RookChessComponent extends ChessComponent {
    ...
    public void loadResource() throws IOException {
        if (ROOK_WHITE == null) {
            ROOK_WHITE = ImageIO.read(new File("C:\\Users\\Gypsophila\\IdeaProjects\\ChessDemo\\src\\images\\rook-white.png"));
        }

        if (ROOK_BLACK == null) {
            ROOK_BLACK = ImageIO.read(new File("C:\\Users\\Gypsophila\\IdeaProjects\\ChessDemo\\src\\images\\rook-black.png"));
        }
    }
