...
public class KnightChessComponent extends ChessComponent{
    ...
    public void loadResource() throws IOException {
        if (KNIGHT_WHITE == null) {
            KNIGHT_WHITE = ImageIO.read(new File("C:\\Users\\Gypsophila\\IdeaProjects\\ChessDemo\\src\\images\\knight-white.png"));
        }

        if (KNIGHT_BLACK == null) {
            KNIGHT_BLACK = ImageIO.read(new File("C:\\Users\\Gypsophila\\IdeaProjects\\ChessDemo\\src\\images\\knight-black.png"));
        }
    }
