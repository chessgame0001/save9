...
public class KingChessComponent extends ChessComponent{
    ...
    public void loadResource() throws IOException {
        if (KING_WHITE == null) {
            KING_WHITE = ImageIO.read(new File("C:\\Users\\Gypsophila\\IdeaProjects\\ChessDemo\\src\\images\\king-white.png"));
        }

        if (KING_BLACK == null) {
            KING_BLACK = ImageIO.read(new File("C:\\Users\\Gypsophila\\IdeaProjects\\ChessDemo\\src\\images\\king-black.png"));
        }
    }
    ...
    public boolean canMoveTo(ChessComponent[][] chessComponents, ChessboardPoint destination){
        ...
        if(Math.abs(source.getX()-destination.getX())>1){
            ...
            for (int i=0;i<steps.size();i++){
                java.util.List<ChessComponent> step=steps.get(i);
